 ...
 export const instructors = [
    {
      ...
      bio: <>
        <li>🎓 Образование: МГКИ (эстрадно-джазовый вокал)</li>
        <li>⭐ Повышала квалификацию на курсах Estill Voice Training и у Дарьи Манаковой</li>
        <li>🎤 Солистка джаз-банда Extra Time Jazz Band</li>
    ...
    },
   {
     ...
     bio: <>
       <li>🎓Высшее муз. образование (МПГУ)</li>
       <li>⭐ Курсы Estill Voice</li>
       <li>⭐ мастер-классы у Дарьи Манаковой и Ольги Кляйн</li>
       <li>🎙️ Организую концерты для учеников!</li>
       <li>📚 Опыт преподавания: 10 лет</li>
      </>,
