    ...
    return (
        ...
        <div className="min-h-screen font-exo2">
            <main className="flex-1 primary-bg w-full">
                ...
                <section className="container mx-auto flex h-screen">
                    <div className="relative flex w-full z-10 justify-center">
                        ...
                        <div className="z-51 p-8 flex flex-col gap-y-6 lg:justify-center xl:gap-y-9">
                            ...
                            <h1 className="typing-animation overflow-hidden text-nowrap mx-auto pr-3 text-2xl text-white font-bold xl:text-5xl">
                                Пусть тебя
                                <span className="text-primary"> УСЛЫШАТ!</span>
                            </h1>
                            <div className='hidden text-xl font-semibold text-white text-center md:block lg:text-3xl'>От мечты — к сцене</div>
                ...
                {/* Programs Section */}
                <section id="subscriptions" className="main-bg text-white px-4 py-10 lg:py-16">
                    <div className="container mx-auto flex flex-col mb-4 md:mb-8">
                        <h2 className="text-4xl md:text-3xl font-bold text-shadow-lg tracking-tight mb-4 xl:text-6xl">
                            Наши<br />абонементы
                        </h2>
                ...
                <section className="container mx-auto px-4 py-10 text-white lg:py-16">
                    <div className="flex flex-col mb-6 md:mb-8 md:items-center md:text-center">
                        <h2 className="text-white text-shadow-lg text-4xl md:text-3xl font-bold tracking-tight mb-4 xl:text-6xl">
                            Наши<br />
                            <span className='ml-2'>социальные сети</span>
                        </h2>
                        {/* <h2 className="text-2xl md:text-3xl font-bold text-shadow-lg tracking-tight mb-4">
