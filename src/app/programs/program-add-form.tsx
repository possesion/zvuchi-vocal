...
export function ProgramAddForm() {
    ...
    const {
        ...
        defaultValues: {
            ...
            short_description: '',
            full_description: '',
            packages: [{ lessons_count: 4, price: 0 }],
            lesson_duration: 55,
            program_duration: 30,
            features: '',
            is_popular: false,
    ...
    const onSubmit = async (data: ProgramForm) => {
        ...
        if (result.success) {
            ...
            // Ошибка обрабатывается через formState
        }
    };
    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)} className="mb-8 rounded-sm bg-white/10 p-4 md:p-6 backdrop-blur-sm space-y-4 mx-4 md:mx-0">
            ...
            <div className="grid gap-4 md:grid-cols-2">
                <div className="flex items-center gap-2">
                    ...
                    />
                    <label htmlFor="is_popular" className="text-sm text-gray-300 cursor-pointer">
