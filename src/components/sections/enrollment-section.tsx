        ...
        <QuizProvider>
            <section id="study" className="bg-muted/50">
                <div className='sm:hidden'>
                    <QuizButton>
                        <button
                            className='group relative bg-radial-[at_40%] from-violet-800 to-violet-950 to-80% shadow-[0_0_45px_5px] shadow-purple-900 mb-4 cursor-pointer overflow-hidden rounded-sm px-8 py-3 text-xl font-bold text-white transition-all duration-300 hover:scale-105'>
                ...
                <div className="flex flex-col gap-2">
                    <div className="flex flex-col-reverse gap-x-2 ">
                        <div className="hidden sm:block sm:bg-white md:w-[630px] sm:h-[630px] shadow-md rounded-sm">
                            <QuizModalContent className="text-black h-full pt-8 pb-6 px-4 md:p-6 flex flex-col justify-between" />
                        </div>
                    </div>
                </div>
            </section>
